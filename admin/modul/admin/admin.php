        ...
        ?>
            <div class="container">
                <center>
                    ...
                    <button type="button" class="btn btn-primary mb-5" onclick="location.href='?menu=admin&act=editor'">Tambah</button>
                </center>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <td>' . $row[1] . '</td>
                        <td>' . $row[2] . '</td>
                        <td class="text-center"><a class="btn btn-warning" href="?menu=admin&act=editor&id=' . $row[0] . '">Edit </a>
                            <a class="btn btn-danger" onclick="return confirm(\'Apakah anda yakin akan menghapus?\')"
