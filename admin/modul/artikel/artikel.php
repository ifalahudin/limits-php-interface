...
?>
            <div class="container">
                ...
                <form action="<?php echo $link; ?>?menu=artikel&act=<?php echo $aksi; ?>" method=post id="frmmodul" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="nama">ID Artikel</label>
        ...
        ?>
            <div class="container">
                <center>
                    <h3>Menu Artikel</h3>
                    <button type="button" class="btn btn-primary mb-5" onclick="location.href='?menu=artikel&act=editor'">Tambah</button>
                </center>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-danger" onclick="return confirm(\'Apakah anda yakin akan menghapus?\')" href="' . $link . '?menu=modul&act=delete&id=' . $row[0] . '">Hapus</a>
                        </td>
                        </tr>';
                            $no++;
                        }
